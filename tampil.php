...
if(isset($_SESSION['masuk'])) {  
   ...
   if ($_SESSION['level'] == "admin") {
    ...
    $user = '';
        ...
        $id=$_GET['id'];
        $query_mysql = mysql_query("SELECT* FROM tb_post WHERE id_post='$id'", $conn);
        $nomor=1;
        $data=mysql_fetch_array($query_mysql);
        $suka = $data['suka'];
        $lihat = $data['lihat'] +1;
        mysql_query("UPDATE tb_post SET lihat='$lihat' WHERE id_post='$id'", $conn);
        ...
        if (isset($_POST['batalsuka'])) {
          ...
          $batalsuka--;
          mysql_query("UPDATE tb_post SET suka='$batalsuka' WHERE id_post='$id'", $conn);
        }
