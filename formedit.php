...
<body>
	...
	include "koneksi.php";
	$id=$_GET['id'];
	$query_mysql = mysql_query("SELECT* FROM tb_post WHERE id_post='$id'")or die(mysql_error());
	$nomor=1;
...
<form action="foto.php" method="POST" enctype="multipart/form-data">
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="judul" id="judul" placeholder="Masukan Isi Judul Postingan" value="<?= $data['judul_post']?>">
  </div>
  <div class="form-group col-lg-16">
    <label for="isi">Isi Postingan</label>
    <textarea type="text" class="form-control" id="isi" name="isi" rows="5" placeholder="Masukan Isi Postingan"><?= $data['isi_post'] ?></textarea>
  </div>
  <div class="form-group">
