...
<form action="upload.php" method="POST" enctype="multipart/form-data">
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="judul" id="judul" placeholder="Masukan Isi Judul Postingan">
  </div>
  <div class="form-group col-lg-16">
    <label for="isi">Isi Postingan</label>
    <textarea type="text" class="form-control" id="isi" name="isi" rows="5" placeholder="Masukan Isi Postingan"></textarea>
  </div>
  <div class="form-group">
